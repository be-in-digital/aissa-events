...
export const packDocs = [
  ...
  // Evenement — les quatre packs Business (directives webmaster, juillet 2026).
  // « idealFor » alimente le bloc « Idéal pour », « includedItems » le bloc
  // « Selon le projet ». Aucun prix affiché (showPrices=false côté section).
  {
    _id: "pack-evenement-reunion",
    _type: "pack",
    title: "Pack Réunion & Séminaire",
    slug: { _type: "slug", current: "evenement-reunion-seminaire" },
    type: "evenement",
    tagline: "Une journée professionnelle organisée et pilotée de A à Z.",
    idealFor: [
      "Réunions",
      "Formations",
      "Conventions",
  ...
  {
    _id: "pack-evenement-afterwork",
    _type: "pack",
    title: "Pack Afterwork",
    slug: { _type: "slug", current: "evenement-afterwork" },
    type: "evenement",
    tagline: "Un moment convivial pour rassembler les équipes et valoriser l'entreprise.",
    idealFor: ["Afterworks", "Cocktails", "Networking", "Soirées clients"],
    includedItems: [
      "Lieu",
      "Cocktail",
      "Boissons",
  ...
  },
  {
    ...
    type: "evenement",
    tagline:
      "L'offre phare d'Aïssa Events : une expérience élégante portée par notre signature musicale.",
    idealFor: [
      "Lancements",
      "Inaugurations",
      "Événements clients",
      "Célébrations de marque",
      "Soirées premium",
    ],
    includedItems: [
      "Direction artistique",
  ...
  {
    _id: "pack-evenement-findannee",
    _type: "pack",
    title: "Pack Événement de fin d'année",
    slug: { _type: "slug", current: "evenement-fin-annee" },
    type: "evenement",
    tagline:
      "Une soirée festive clé en main pour remercier les collaborateurs et célébrer les réussites.",
    idealFor: [
