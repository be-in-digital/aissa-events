...
const FALLBACK_ITEMS = [
  { value: "Diplômée", label: "École française de wedding planning" },
  { value: "60+ mariages", label: "orchestrés depuis 2020" },
  { value: "Suivi personnel", label: "Aïssa au bout du fil" },
  { value: "Émerainville (77)", label: "Île-de-France · partout en France" },
];
...
export function MariageTrustBar({ data }: { data?: TrustBarData }) {
  ...
  const items = (sanityItems.length > 0 ? sanityItems : FALLBACK_ITEMS).map(
    (item, i) => ({
