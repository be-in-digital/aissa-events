      ...
      <div className="mx-auto max-w-[1440px] px-6 sm:px-14">
              ...
              <div className="px-9 pb-9">
                {m.ctaExternal ? (
                  <a
                    ...
                    className={`group block rounded-full px-6 py-4 text-center font-sans text-[11px] font-medium uppercase tracking-[0.2em] transition-colors ${
                      m.featured
        ...
        >
          <div className="mb-6 flex items-end justify-between gap-4">
            ...
            <Link
              href="/#contact"
              className="hidden items-center gap-1.5 font-mono text-[10.5px] uppercase tracking-[0.22em] text-muted-ink transition-colors hover:text-bordeaux sm:inline-flex"
            >
