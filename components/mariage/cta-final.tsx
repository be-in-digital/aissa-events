...
const FALLBACK_EYEBROW = "Parlons de votre mariage";
const FALLBACK_TITLE = "Parlez-nous\nde votre\n_mariage._";
...
export function MariageCtaFinal({ data }: { data?: FinalCtaData }) {
  ...
  // For ctaSection schema, eyebrow is not present, so we keep our fallback eyebrow
