...
type StickyCtaData = NonNullable<EvenementPageQueryResult>["stickyCta"];

const FALLBACK_LABEL = "Devis sous 48 h";
const FALLBACK_SUBLABEL = "Facturation entreprise";
const FALLBACK_CTA_LABEL = "Réserver un appel";

export function EvenementStickyCta({ data }: { data?: StickyCtaData }) {
