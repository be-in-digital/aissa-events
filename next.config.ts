...
const publicCsp = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://limova-web-sltj.onrender.com",
  "style-src 'self' 'unsafe-inline' https://limova-web-sltj.onrender.com",
  "img-src 'self' data: blob: https://cdn.sanity.io https://image.mux.com https://images.unsplash.com https://limova-web-sltj.onrender.com",
  "font-src 'self' data: https://limova-web-sltj.onrender.com",
  "media-src 'self' https://stream.mux.com",
  "frame-src https://calendly.com https://*.calendly.com https://stream.mux.com https://limova-web-sltj.onrender.com",
  "connect-src 'self' https://*.sanity.io https://*.apicdn.sanity.io https://*.upstash.io https://api.hubspot.com https://api.resend.com https://stream.mux.com https://limova-web-sltj.onrender.com wss://limova-web-sltj.onrender.com",
