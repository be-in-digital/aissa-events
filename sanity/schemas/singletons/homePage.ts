...
export const homePage = defineType({
  ...
  groups: [
    ...
    { name: "leadMagnet", title: "— (masqué) Lead Magnet (catalogues)" },
    { name: "ordering", title: "⬆ Ordre des sections" },
    { name: "seo", title: "SEO" },
  ],
  fields: [
    ...
    defineField({
      ...
      description: "Glissez-déposez pour réorganiser les sections de la page.",
      type: "array",
      of: [{ type: "string" }],
      options: { sortable: true },
      initialValue: ["hero", "marquee", "caseStudies", "universes", "process", "about", "pillars", "testimonials", "faq", "leadMagnet", "contact"],
      group: "ordering",
    }),
